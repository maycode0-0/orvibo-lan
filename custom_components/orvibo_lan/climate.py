...
async def async_setup_entry(
    ...
    class OrviboLanClimate(OrviboLanEntity, ClimateEntity):
        """Orvibo 空调实体。"""
        ...
        def _parse_hvac_mode(self, st: dict) -> HVACMode:
            ...
            v2 = int(v2)
            mode_map = {2: HVACMode.DRY, 3: HVACMode.COOL, 4: HVACMode.HEAT, 7: HVACMode.FAN_ONLY}
        ...
        async def async_set_hvac_mode(self, hvac_mode):
            ...
            if hvac_mode == "off":
                ...
                mode_str = (
                    str(hvac_mode).split(".")[-1].lower()
                    if "." in str(hvac_mode)
                    else str(hvac_mode).lower()
                )
